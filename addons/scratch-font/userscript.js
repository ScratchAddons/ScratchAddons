export default async function ({ addon, console }) {
	...
	function previewScratchFont() {
		...
		document.querySelector("[class*='font-dropdown_displayed-font-name']").className = 'font-dropdown_scratch ' + addon.tab.scratchClass('font-dropdown_displayed-font-name');
	}
	
	function addFontButton(fontDropdown) {
		const menuItem = document.createElement('span');
		menuItem.className = addon.tab.scratchClass('button_button') + ' ' + addon.tab.scratchClass('font-dropdown_mod-menu-item');
