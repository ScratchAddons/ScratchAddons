...
//function Bezier(c){return new Bezier(c)}
/*
Maker.js
...
export default async function ({ addon, console, msg }) {
  ...
  function addTabContent(holder) {
    ...
    const inputFill = createElement('input', { id: 'sa-svg-maker-input-fill', type: 'text', value: '#000', className: 'sa-svg-maker-input sa-svg-maker-input-fill', 'data-coloris': '' });
    holder.appendChild(createInputHolder(`${msg('fill')}:`, inputFill));

    const inputStroke = createElement('input', { id: 'sa-svg-maker-input-stroke', type: 'text', value: '#000', className: 'sa-svg-maker-input sa-svg-maker-input-stroke', 'data-coloris': '' });
    ...
    const copyToClipboardBtn = createElement('button', { id: 'sa-svg-maker-copy-to-clipboard-btn', className: 'sa-svg-maker-btn sa-svg-maker-hidden', innerHTML: 'Copy to Clipboard' });
	...
	var app = new App();
		...
		app.getGoogleFonts('AIzaSyAOES8EmKhuJEnsn9kS1XKBpxxp-TgN8Jc', app);
		app.handleEvents();
  }
