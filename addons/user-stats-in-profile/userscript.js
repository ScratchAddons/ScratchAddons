export default async function ({ addon }) {
    ...
    function addStatsToProfile(statsData) {
        ...
        const stats = [
            ...
            {icon: 'https://scratch.mit.edu/svgs/project/remix-gray.svg', count: statsData.totalRemixes, alt: '🔄', className: 'remix-icon'},
            {icon: 'https://scratch.mit.edu/svgs/project/views-gray.svg', count: statsData.totalViews, alt: '👁️', className: 'views-icon'}
        ];
