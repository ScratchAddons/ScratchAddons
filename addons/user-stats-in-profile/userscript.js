export default async function ({ addon }) {
    ...
    const statsElements = [
        ...
        {icon: 'https://scratch.mit.edu/svgs/project/remix-gray.svg', count: '?', alt: '🔄', className: 'remix-icon', key: 'remixes'},
        {icon: 'https://scratch.mit.edu/svgs/project/views-gray.svg', count: '?', alt: '👁️', className: 'views-icon', key: 'views'}
    ];
    ...
    async function calculateRemixes() {
        ...
        do {
            const res = await fetch(`https://api.scratch.mit.edu/users/${username}/projects/?limit=${limit}&offset=${offset}`);
