export default async function ({ addon, global, console }) {
  ...
  const messages = {
    event_broadcast: "Switch to broadcast",
    event_broadcastandwait: "Switch to broadcast and wait",
    control_if: "Switch to if",
    control_if_else: "Switch to if... else",
    data_changevariableby: "Switch to change variable",
    data_setvariableto: "Switch to set variable",
    data_showvariable: "Switch to show variable",
    data_hidevariable: "Switch to hide variable",
    looks_changeeffectby: "Switch to change effect",
    looks_seteffectto: "Switch to set effect",
    looks_changesizeby: "Switch to change size",
    looks_setsizeto: "Switch to set size",
    looks_costumenumbername: "Switch to costume number/name",
    looks_backdropnumbername: "Switch to backdrop number/name",
    looks_show: "Switch to show",
    looks_hide: "Switch to hide",
    looks_nextcostume: "Switch to next costume",
    looks_nextbackdrop: "Switch to next backdrop",
    motion_turnright: "Switch to turn right",
    motion_turnleft: "Switch to turn left",
    motion_setx: "Switch to set X",
    motion_changexby: "Switch to change X",
    motion_sety: "Switch to set Y",
    motion_changeyby: "Switch to change Y",
    motion_xposition: "Switch to X",
    motion_yposition: "Switch to Y",
    operator_equals: "Switch to =",
    operator_gt: "Switch to >",
    operator_lt: "Switch to <",
    operator_add: "Switch to +",
    operator_subtract: "Switch to -",
    operator_multiply: "Switch to *",
    operator_divide: "Switch to /",
    operator_mod: "Switch to mod",
    operator_and: "Switch to and",
    operator_or: "Switch to or",
    pen_penDown: "Switch to pen down",
    pen_penUp: "Switch to pen up",
    pen_setPenColorParamTo: "Switch to set parameter",
    pen_changePenColorParamBy: "Switch to change parameter",
    pen_changePenHueBy: "Switch to change hue",
    pen_setPenHueToNumber: "Switch to set hue",
    pen_changePenShadeBy: "Switch to change shade",
    pen_setPenShadeToNumber: "Switch to set shade",
    pen_changePenSizeBy: "Switch to change size",
    pen_setPenSizeTo: "Switch to set size",
    sensing_mousex: "Switch to mouse X",
    sensing_mousey: "Switch to mouse Y",
    sound_play: "Switch to play",
    sound_playuntildone: "Switch to play until done",
    sound_changeeffectby: "Switch to change effect",
    sound_seteffectto: "Switch to set effect",
    sound_setvolumeto: "Switch to set volume",
