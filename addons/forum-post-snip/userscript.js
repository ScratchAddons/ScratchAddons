export default async function (/** @type {import("../../addon-api/content-script/typedef.js").UserscriptUtilities} */{ addon, global, console, msg }) {
    ...
    function indexPost(quote, currentIndex = 0) {
        ...
        for (const blockquote of [...quote.children].filter(e => e.tagName === "BLOCKQUOTE")) {
            if (nextIndex >= addon.settings.get("pc")) {
                ...
                const clonedSender = [...blockquote.children].find(e => e.classList.contains("bb-quote-author")).cloneNode(true);
