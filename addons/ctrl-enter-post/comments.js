export default async function({ addon, global, console, msg }) {
    ...
    let textboxSelector = isScratchR2 ? '[name=\'content\']' : '[name=\'compose-comment\']'
    ...
    while (true) {
        ...
        var button;
        if (isScratchR2) {
            button = textbox.parentNode.querySelector('.control-group:not(.tooltip) div[data-control=\'post\']')
        } else {
