export default async function ( addon ) {
  ...
  if (document.querySelector('#profile-box .player [data-control="edit"]')) wrapperElement.appendChild(changeFeaturedElement)
  ...
  const loadScratch = () => {
    ...
    if (autoPlay) iframeElement.addEventListener("load", function callback() {
  ...
  const loadForkphorus = () => {
    ...
    iframeElement.setAttribute("src", `https://forkphorus.github.io/embed.html?id=${projectId}&auto-start=${autoPlay}&ui=${showMenu}`)
