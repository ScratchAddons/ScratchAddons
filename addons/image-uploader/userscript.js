...
export default async function ({ addon, global, console, msg, safeMsg }) {
  ...
  if (toolbar && textBox) {
    ...
    document
      ...
      .insertAdjacentHTML(
        "afterend",
        `<li class="markItUpButton markItUpButton17"><a id="uploadButton" href="javascript:;" title="${safeMsg("upload-image")}" style="background-image: url('data:image/png;base64,');">${safeMsg("upload")}</a></li>`
      );
