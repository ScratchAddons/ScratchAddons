...
export default async function ({ addon, global, console, msg }) {
  ...
  async function deleteProject(projectId) {
    let res = await fetch(`https://scratch.mit.edu/site-api/projects/all/${projectId}/`, {
      ...
      body: `{\"view_count\":0,\"favorite_count\":0,\"remixers_count\":0,\"creator\":{\"username\":\"Scratch\",\"pk\":53088961,\"thumbnail_url\":\"//uploads.scratch.mit.edu/users/avatars/default.png\",\"admin\":false},\"title\":\"Scratch Image Uploader Autogenerated Project\",\"isPublished\":false,\"datetime_created\":\"2020-07-24T10:27:23\",\"thumbnail_url\":\"//uploads.scratch.mit.edu/projects/thumbnails/413641266.png\",\"visibility\":\"trshbyusr\",\"love_count\":0,\"datetime_modified\":\"2020-07-24T10:27:24\",\"uncached_thumbnail_url\":\"//cdn2.scratch.mit.edu/get_image/project/${projectId}_100x80.png\",\"thumbnail\":\"${projectId}.png\",\"datetime_shared\":null,\"commenters_count\":0,\"id\":${projectId}}`,
      method: "PUT",
      credentials: "include",
    });
  }
