export default async function ({ addon, console, msg }) {
  ...
  while (true) {
    ...
    container.appendChild(document.createTextNode(msg(projectInfo.spriteCount == 1 ? "sprite" : "sprites", { num: projectInfo.spriteCount })));
    container.appendChild(document.createElement("br"));
    container.appendChild(document.createTextNode(msg(projectInfo.spriteCount == 1 ? "script" : "scripts", { num: projectInfo.spriteCount })));
  }
}
