export default async function ({ addon, global, console }) {
    ...
    if (document.getElementById("curator-action-bar")) {
        ...
        document.getElementById("curator-action-bar").insertBefore(leaveButton, document.getElementById("show-add-curator").nextSibling);
    } else {
        ...
        document.getElementById("tabs-content").insertBefore(actionBarDiv, document.getElementById("tabs-content").firstChild);
    }
}
