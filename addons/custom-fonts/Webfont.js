...
!(function () {
    ...
    function k(t, n) {
        (this.c = t), (this.f = t.m.document.documentElement), (this.h = n), (this.a = new w("-")), (this.j = !1 !== n.events), (this.g = !1 !== n.classes);
    }
    function T(t) {
        if (t.g) {
    ...
    function F(t, n, i, e, o, a, s) {
        (this.v = t),
            ...
            (t = E((t = new y(this.a.c + ",serif", j(this.a))))),
            (this.g.a.style.cssText = t),
            (t = E((t = new y(this.a.c + ",sans-serif", j(this.a))))),
            (this.h.a.style.cssText = t),
            (t = E((t = new y("serif", j(this.a))))),
            (this.j.a.style.cssText = t),
            (t = E((t = new y("sans-serif", j(this.a))))),
    ...
    function O(t, n, i) {
        for (var e in I) if (I.hasOwnProperty(e) && n === t.f[I[e]] && i === t.f[I[e]]) return !0;
        return !1;
    }
    function L(t, n) {
        setTimeout(
            i(function () {
                f(this.g.a), f(this.h.a), f(this.j.a), f(this.o.a), n(this.a);
            }, t),
            0
        );
    }
        ...
        (this.f.serif = this.j.a.offsetWidth),
            ...
            (function t(n) {
                var o,
                    a = n.g.a.offsetWidth,
                    s = n.h.a.offsetWidth;
                (o = a === n.f.serif && s === n.f["sans-serif"]) || (o = B() && O(n, a, s)),
                    o
                        ? e() - n.A >= n.w
                            ? B() && O(n, a, s) && (null === n.u || n.u.hasOwnProperty(n.a.c))
                                ? L(n, n.v)
                                : L(n, n.B)
                            : (function (n) {
                                  setTimeout(
    ...
    var $ = null;
    function q(t) {
        0 == --t.f && t.j && (t.o ? ((t = t.a).g && c(t.f, [t.a.c("wf", "active")], [t.a.c("wf", "loading"), t.a.c("wf", "inactive")]), S(t, "active")) : T(t.a));
    }
    function H(t) {
                ...
                if (0 === e.length && s) T(n.a);
                    ...
                    for (f = 0; f < e.length; f++) {
                        ...
                        p.g && c(p.f, [p.a.c("wf", d.c, j(d).toString(), "loading")]),
                            S(p, "fontloading", d),
                            (p = null),
                            null === $ && ($ = !!window.FontFace && (!(d = /Gecko.*Firefox\/(\d+)/.exec(window.navigator.userAgent)) || 42 < parseInt(d[1], 10))),
                            (p = $ ? new W(i(n.g, n), i(n.h, n), n.c, l, n.s, u) : new F(i(n.g, n), i(n.h, n), n.c, l, n.s, t, u)),
                            h.push(p);
                    }
    ...
    function K(t, n, i) {
        (this.c = t || n + R), (this.a = []), (this.f = []), (this.g = i || "");
    }
    (D.prototype.g = function (t) {
        var n = this.a;
        n.g && c(n.f, [n.a.c("wf", t.c, j(t).toString(), "active")], [n.a.c("wf", t.c, j(t).toString(), "loading"), n.a.c("wf", t.c, j(t).toString(), "inactive")]), S(n, "fontactive", t), (this.o = !0), q(this);
    }),
        (D.prototype.h = function (t) {
            ...
            if (n.g) {
                ...
                i || e.push(n.a.c("wf", t.c, j(t).toString(), "inactive")), c(n.f, e, o);
            }
        ...
        (G.prototype.load = function (t) {
            var n,
                ...
                s = new d();
            for (n = 0, i = e.length; n < i; n++) u(this.c, e[n], g(s));
            var r = [];
            for (n = 0, i = o.length; n < i; n++)
                if ((e = o[n].split(":"))[1]) for (var f = e[1].split(","), c = 0; c < f.length; c += 1) r.push(new y(e[0], f[c]));
                else r.push(new y(e[0]));
            v(s, function () {
                t(r, a);
            });
        });
    var R = "//fonts.googleapis.com/css";
    function U(t) {
    ...
    (Y.prototype.load = function (t) {
        var n = new d(),
            i = this.c,
            e = new K(this.a.api, l(i), this.a.text),
            o = this.a.families;
        !(function (t, n) {
                ...
                if (2 <= e.length) {
                    ...
                    if (((s = []), (r = e[1])))
                        for (var r, f = (r = r.split(",")).length, c = 0; c < f; c++) {
                            var h;
                            if ((h = r[c]).match(/^[\w-]+$/))
                                if (null == (l = X.exec(h.toLowerCase()))) h = "";
                                else {
                                    if (((h = null == (h = l[2]) || "" == h ? "n" : V[h]), null == (l = l[1]) || "" == l)) l = "4";
                                    else var l = Q[l] || (isNaN(l) ? "4" : l.substr(0, 1));
                                    h = [h, l].join("");
                                }
                            else h = "";
                            h && s.push(h);
                        }
                    0 < s.length && (a = s), 3 == e.length && ((s = []), 0 < (e = (e = e[2]) ? e.split(",") : s).length && (e = J[e[0]]) && (t.c[o] = e));
                }
                for (t.c[o] || ((e = J[o]) && (t.c[o] = e)), e = 0; e < a.length; e += 1) t.a.push(new y(o, a[e]));
            }
        })(a),
            u(
                i,
                ...
                ? p(
                      ...
                      function (n) {
                          if (n) t([]);
                              ...
                              for (var e = [], o = 0; o < n.length; o += 2) for (var a = n[o], s = n[o + 1], r = 0; r < s.length; r++) e.push(new y(a, s[r]));
                              try {
    ...
    "function" == typeof define && define.amd
        ...
        ? (module.exports = et)
        : ((window.WebFont = et), window.WebFontConfig && it.load(window.WebFontConfig));
})();
