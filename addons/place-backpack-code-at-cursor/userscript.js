export default async function ({ addon }) {
    const { traps: { vm }, redux } = await addon.tab;
    ...
    const newShareBlocksToTarget = function (blocks, targetId, _) {
        ...
        if (topBlock) {
            ...
            const posY = -scrollY - 95, posX = isRtl ? scrollX - 60 : -scrollX - 60;
    ...
    const enableAddon = () => {vm.shareBlocksToTarget = newShareBlocksToTarget}
