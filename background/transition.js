...
chrome.runtime.onInstalled.addListener(async (details) => {
  ...
  if (details.previousVersion && details.previousVersion.startsWith("0")) {
    const url = locale == 'en' ? "https://scratchaddons.com/scratch-messaging-transition" : `https://scratchaddons.com/${locale}/scratch-messaging-transition`
...
if (chrome.runtime.getManifest().version_name.includes("-prerelease") === false) {
  ...
  const uninstallURL = locale == 'en' ? "https://scratchaddons.com/farewell" : `https://scratchaddons.com/${locale}/farewell`
