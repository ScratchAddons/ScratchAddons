...
// https://github.com/scratchfoundation/scratch-blocks/blob/e50d7b8/src/blocks/procedures.ts#L458-L467
...
let toolboxUpdateQueued = false;
const queueToolboxUpdate = () => {
  if (toolboxUpdateQueued) {
    return;
  }
  toolboxUpdateQueued = true;
  queueMicrotask(() => {
    toolboxUpdateQueued = false;
    updateToolboxXML(tabAPI);
  });
};
