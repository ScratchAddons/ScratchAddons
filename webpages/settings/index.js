...
const ColorInput = Vue.extend(ColorInputComponent);
Vue.component("picker", ColorInput);

const ResetDropdown = Vue.extend(ResetDropdownComponent);
Vue.component("reset-dropdown", ResetDropdown);

const AddonGroup = Vue.extend(AddonGroupComponent);
Vue.component("addon-group", AddonGroup);

const AddonBody = Vue.extend(AddonBodyComponent);
...
const AddonTag = Vue.extend(AddonTagComponent);
Vue.component("addon-tag", AddonTag);

const AddonSetting = Vue.extend(AddonSettingComponent);
Vue.component("addon-setting", AddonSetting);

const CategorySelector = Vue.extend(CategorySelectorComponent);
