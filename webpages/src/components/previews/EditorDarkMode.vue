...
.edm-preview[data-setting-hovered="highlightText"] .edm-tab-selected :is(.edm-text-placeholder, .edm-icon-placeholder),
  ...
  computed: {
    colors() {
      return {
        ...
        accentTransparentText: textColor(this.settings.accent, "rgba(87, 94, 117, 0.75)", "rgba(255, 255, 255, 0.75)"),
