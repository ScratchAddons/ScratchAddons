...
class _Renderer {
  ...
  code(code, infostring, escaped) {
    ...
    return (
      '<pre><code class="language-' + escape(lang) + '">' + (escaped ? code : escape(code, true)) + "</code></pre>\n"
    );
  }
  blockquote(quote) {
    return `<blockquote>\n${quote}</blockquote>\n`;
  ...
  #parseMarkdown(lexer, parser) {
    return (src, options) => {
      ...
      if (typeof src !== "string") {
        return throwError(
          new Error("marked(): input parameter is of type " + Object.prototype.toString.call(src) + ", string expected")
        );
      }
      if (opt.hooks) {
