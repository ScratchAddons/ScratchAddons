export default function () {
  ...
  if (prerelease) {
    document.documentElement.style.setProperty("--brand-color", "var(--prerelease-brand-color)");
    document.documentElement.style.setProperty("--brand-color-light", "var(--prerelease-brand-color-light)");
