(function () {
    ...
    (t.isWin = i == "win"),
      ...
      (t.isIE =
        o == "Microsoft Internet Explorer" || o.indexOf("MSAppHost") >= 0
          ? parseFloat((s.match(/(?:MSIE |Trident\/[0-9]+[\.0-9]+;.*rv:)([0-9]+[\.0-9]+)/) || [])[1])
  ...
  define("ace/lib/dom", ["require", "exports", "module", "ace/lib/useragent"], function (e, t, n) {
    ...
    if (typeof document != "undefined") {
      ...
      t.HI_DPI && f.style.transform !== undefined && (t.HAS_CSS_TRANSFORMS = !0),
        !r.isEdge && typeof f.style.animationName != "undefined" && (t.HAS_CSS_ANIMATION = !0),
        (f = null);
    }
    ...
    function (e, t, n) {
      ...
      (t.setLoader = function (e) {
        ...
        (t.loadModule = function (n, r) {
          ...
          var a = function () {
            f(n, function (e, r) {
              t._emit("load.module", { name: n, module: r });
              var i = t.$loading[n];
              (t.$loading[n] = null),
              ...
              if (t) {
                ...
                while (s && s.nodeType == 1)
                  i.push(s),
                    ...
                    !s.parentElement && s.getRootNode ? (s = s.getRootNode().host) : (s = s.parentElement);
              }
          ...
          var P = !1,
            H = function (e, r) {
              ...
              return (
                ...
                (f && !u && !a && !l && !c) || S
                  ? t.onTextInput(f)
                  : t.onTextInput(f, { extendLeft: u, extendRight: a, restoreStart: l, restoreEnd: c }),
                (w = !1),
                (T = e),
                (N = s),
                (C = o),
          ...
          var U = function (e) {
            ...
            z = function () {
              ...
              if (b.useTextareaForIME) t.onCompositionUpdate(n.value);
                ...
                H(e),
                  b.markerRange &&
                    (b.context && (b.markerRange.start.column = b.selectionStart = b.context.compositionStartOffset),
                    (b.markerRange.end.column = b.markerRange.start.column + C - b.selectionStart + k));
              }
            },
            W = function (e) {
  ...
  define("ace/tooltip", ["require", "exports", "module", "ace/lib/oop", "ace/lib/dom"], function (e, t, n) {
    ...
    (function () {
      (this.$init = function () {
        ...
        (this.hide = function () {
          this.isOpen &&
            ((this.getElement().style.display = "none"), (this.getElement().className = s), (this.isOpen = !1));
        }),
      ...
      (function () {
        (this.stopPropagation = function () {
          ...
          (this.getDocumentPosition = function () {
            return this.$pos
              ? this.$pos
              : ((this.$pos = this.editor.renderer.screenToTextCoordinates(this.clientX, this.clientY)), this.$pos);
          }),
              ...
              y.replaceChild(
                s.buildDom(
                  r
                    ? [
                        "span",
                        !n && ["span", { class: "ace_mobile-button", action: "selectall" }, "Select All"],
        ...
        e.on("gutterdblclick", function (t) {
          ...
          if (n == "foldWidgets") {
            ...
            if (o) {
              ...
              u
                ? i.removeFold(u)
                : (i.addFold("...", o), e.renderer.scrollCursorIntoView({ row: o.start.row, column: 0 }));
            }
            t.stop();
          }
        });
      ...
      (function () {
        (this.setDefaultHandler = function (e) {
          ...
          (this.$callKeyboardHandlers = function (e, t, n, r) {
            ...
            return (
              !o && e == -1 && ((s = { command: "insertstring" }), (o = u.exec("insertstring", this.$editor, t))),
    ...
    function q(e, t, n, r) {
      ...
      switch (i) {
        ...
        case N:
          return E;
        case C:
          if (r < 1 || r + 1 >= t.length || ((o = n[r - 1]) != b && o != w) || ((c = t[r + 1]) != b && c != w))
            return E;
    ...
    (function () {
      (this.isBidiRow = function (e, t, n) {
        return this.seenBidi
          ? (e !== this.currentRow && ((this.currentRow = e), this.updateRowLine(t, n), this.updateBidiMap()),
        ...
        (this.updateRowLine = function (e, t) {
            ...
            o &&
              ...
              t > 0 && o.length
                ? ((this.wrapIndent = o.indent),
                  ...
                  (this.line =
                    t < o.length ? this.line.substring(o[t - 1], o[t]) : this.line.substring(o[o.length - 1])))
          ...
          (this.line = this.line.replace(/\t|[\u1100-\u2029, \u202F-\uFFE6]/g, function (e, t) {
            return e === "	" || u.isFullWidth(e.charCodeAt(0))
              ? ((f = e === "	" ? u.getScreenTabSize(t + a) : 2), (a += f - 1), i.stringRepeat(r.DOT, f))
              : e;
          })),
            this.isRtlDir &&
        ...
        (this.getPosLeft = function (e) {
          ...
          return (
            !this.session.getOverwrite() && e > t && s[i] % 2 === 0 && (o += this.charWidths[s[i]]),
        ...
        (this.offsetToCol = function (e) {
          ...
          return (
            r > 0 && i[r - 1] % 2 !== 0 && i[r] % 2 === 0
              ...
              : r > 0 && i[r - 1] % 2 === 0 && i[r] % 2 !== 0
              ? (t = 1 + (e > n ? this.bidiMap.logicalFromVisual[r] : this.bidiMap.logicalFromVisual[r - 1]))
              : (this.isRtlDir && r === i.length - 1 && s === 0 && i[r - 1] % 2 === 0) ||
                (!this.isRtlDir && r === 0 && i[r] % 2 !== 0)
              ? (t = 1 + this.bidiMap.logicalFromVisual[r])
              : (r > 0 && i[r - 1] % 2 !== 0 && s !== 0 && r--, (t = this.bidiMap.logicalFromVisual[r])),
            t === 0 && this.isRtlDir && t++,
            t + this.wrapIndent
          );
        });
        ...
        r.implement(this, s),
          ...
          (this.$setSelection = function (e, t, n, r) {
            ...
            (this.$silent = !0),
              ...
              (this.$cursorChanged || this.$anchorChanged || i != this.$isEmpty || s) && this._emit("changeSelection");
          }),
            ...
            for (var y = 0; y < a.length - 2; y++) {
              ...
              (d = s[o[y]]),
                ...
                d.next &&
                  ...
                  (s = this.states[r]),
                  s || (this.reportError("state doesn't exist", r), (r = "start"), (s = this.states[r])),
            ...
            if (s == "{") {
              ...
              if (s == "\n" || s == "\r\n") {
                ...
                d.isMaybeInsertedClosing(u, a) &&
                  ((g = o.stringRepeat("}", f.maybeInsertedBrackets)), d.clearMaybeInsertedClosing());
                var v = a.substring(u.column, u.column + 1);
                if (v === "}") {
  ...
  define("ace/unicode", ["require", "exports", "module"], function (e, t, n) {
    "use strict";
    var r = [
        48, 9, 8, 25, 5, 0, 2, 25, 48, 0, 11, 0, 5, 0, 6, 22, 2, 30, 2, 457, 5, 11, 15, 4, 8, 0, 2, 0, 18, 116, 2, 1, 3,
        3, 9, 0, 2, 2, 2, 0, 2, 19, 2, 82, 2, 138, 2, 4, 3, 155, 12, 37, 3, 0, 8, 38, 10, 44, 2, 0, 2, 1, 2, 1, 2, 0, 9,
        26, 6, 2, 30, 10, 7, 61, 2, 9, 5, 101, 2, 7, 3, 9, 2, 18, 3, 0, 17, 58, 3, 100, 15, 53, 5, 0, 6, 45, 211, 57, 3,
        18, 2, 5, 3, 11, 3, 9, 2, 1, 7, 6, 2, 2, 2, 7, 3, 1, 3, 21, 2, 6, 2, 0, 4, 3, 3, 8, 3, 1, 3, 3, 9, 0, 5, 1, 2,
        4, 3, 11, 16, 2, 2, 5, 5, 1, 3, 21, 2, 6, 2, 1, 2, 1, 2, 1, 3, 0, 2, 4, 5, 1, 3, 2, 4, 0, 8, 3, 2, 0, 8, 15, 12,
        2, 2, 8, 2, 2, 2, 21, 2, 6, 2, 1, 2, 4, 3, 9, 2, 2, 2, 2, 3, 0, 16, 3, 3, 9, 18, 2, 2, 7, 3, 1, 3, 21, 2, 6, 2,
        1, 2, 4, 3, 8, 3, 1, 3, 2, 9, 1, 5, 1, 2, 4, 3, 9, 2, 0, 17, 1, 2, 5, 4, 2, 2, 3, 4, 1, 2, 0, 2, 1, 4, 1, 4, 2,
        4, 11, 5, 4, 4, 2, 2, 3, 3, 0, 7, 0, 15, 9, 18, 2, 2, 7, 2, 2, 2, 22, 2, 9, 2, 4, 4, 7, 2, 2, 2, 3, 8, 1, 2, 1,
        7, 3, 3, 9, 19, 1, 2, 7, 2, 2, 2, 22, 2, 9, 2, 4, 3, 8, 2, 2, 2, 3, 8, 1, 8, 0, 2, 3, 3, 9, 19, 1, 2, 7, 2, 2,
        2, 22, 2, 15, 4, 7, 2, 2, 2, 3, 10, 0, 9, 3, 3, 9, 11, 5, 3, 1, 2, 17, 4, 23, 2, 8, 2, 0, 3, 6, 4, 0, 5, 5, 2,
        0, 2, 7, 19, 1, 14, 57, 6, 14, 2, 9, 40, 1, 2, 0, 3, 1, 2, 0, 3, 0, 7, 3, 2, 6, 2, 2, 2, 0, 2, 0, 3, 1, 2, 12,
        2, 2, 3, 4, 2, 0, 2, 5, 3, 9, 3, 1, 35, 0, 24, 1, 7, 9, 12, 0, 2, 0, 2, 0, 5, 9, 2, 35, 5, 19, 2, 5, 5, 7, 2,
        35, 10, 0, 58, 73, 7, 77, 3, 37, 11, 42, 2, 0, 4, 328, 2, 3, 3, 6, 2, 0, 2, 3, 3, 40, 2, 3, 3, 32, 2, 3, 3, 6,
        2, 0, 2, 3, 3, 14, 2, 56, 2, 3, 3, 66, 5, 0, 33, 15, 17, 84, 13, 619, 3, 16, 2, 25, 6, 74, 22, 12, 2, 6, 12, 20,
        12, 19, 13, 12, 2, 2, 2, 1, 13, 51, 3, 29, 4, 0, 5, 1, 3, 9, 34, 2, 3, 9, 7, 87, 9, 42, 6, 69, 11, 28, 4, 11, 5,
        11, 11, 39, 3, 4, 12, 43, 5, 25, 7, 10, 38, 27, 5, 62, 2, 28, 3, 10, 7, 9, 14, 0, 89, 75, 5, 9, 18, 8, 13, 42,
        4, 11, 71, 55, 9, 9, 4, 48, 83, 2, 2, 30, 14, 230, 23, 280, 3, 5, 3, 37, 3, 5, 3, 7, 2, 0, 2, 0, 2, 0, 2, 30, 3,
        52, 2, 6, 2, 0, 4, 2, 2, 6, 4, 3, 3, 5, 5, 12, 6, 2, 2, 6, 67, 1, 20, 0, 29, 0, 14, 0, 17, 4, 60, 12, 5, 0, 4,
        11, 18, 0, 5, 0, 3, 9, 2, 0, 4, 4, 7, 0, 2, 0, 2, 0, 2, 3, 2, 10, 3, 3, 6, 4, 5, 0, 53, 1, 2684, 46, 2, 46, 2,
        132, 7, 6, 15, 37, 11, 53, 10, 0, 17, 22, 10, 6, 2, 6, 2, 6, 2, 6, 2, 6, 2, 6, 2, 6, 2, 6, 2, 31, 48, 0, 470, 1,
        36, 5, 2, 4, 6, 1, 5, 85, 3, 1, 3, 2, 2, 89, 2, 3, 6, 40, 4, 93, 18, 23, 57, 15, 513, 6581, 75, 20939, 53, 1164,
        68, 45, 3, 268, 4, 27, 21, 31, 3, 13, 13, 1, 2, 24, 9, 69, 11, 1, 38, 8, 3, 102, 3, 1, 111, 44, 25, 51, 13, 68,
        12, 9, 7, 23, 4, 0, 5, 45, 3, 35, 13, 28, 4, 64, 15, 10, 39, 54, 10, 13, 3, 9, 7, 22, 4, 1, 5, 66, 25, 2, 227,
        42, 2, 1, 3, 9, 7, 11171, 13, 22, 5, 48, 8453, 301, 3, 61, 3, 105, 39, 6, 13, 4, 6, 11, 2, 12, 2, 4, 2, 0, 2, 1,
        2, 1, 2, 107, 34, 362, 19, 63, 3, 53, 41, 11, 5, 15, 17, 6, 13, 1, 25, 2, 33, 4, 2, 134, 20, 9, 8, 25, 5, 0, 2,
      ...
      (function () {
        (this.$defaultBehaviour = new o()),
            ...
            if (!this.lineCommentStart) {
              ...
              var c = this.blockComment.start,
                ...
                v = function (e, t) {
                  if (g(e, t)) return;
                  if (!s || /\S/.test(e))
                    i.insertInLine({ row: t, column: e.length }, h), i.insertInLine({ row: t, column: u }, c);
                },
                m = function (e, t) {
                  var n;
              ...
              var m = function (e, t) {
                ...
                v = function (e, t) {
                  if (!s || /\S/.test(e))
                    b(e, u, u) ? i.insertInLine({ row: t, column: u }, y) : i.insertInLine({ row: t, column: u }, c);
                },
                g = function (e, t) {
                  return p.test(e);
                },
          ...
          (this.$createKeywordList = function () {
            return (
              this.$highlightRules || this.getTokenizer(), (this.$keywordList = this.$highlightRules.$keywordList || [])
            );
          }),
      ...
      (function () {
        r.implement(this, s),
          ...
          (this.removeFullLines = function (e, t) {
            ...
            return (
              this.applyDelta({ start: f.start, end: f.end, action: "remove", lines: this.getLinesForRange(f) }), l
            );
          }),
          ...
          (this.update = function (e, t, n, i) {
            ...
            for (var f = o; f <= u; f++) {
              ...
              l == null &&
                ...
                l.length > this.MAX_RANGES && (l = l.slice(0, this.MAX_RANGES)),
                (l = l.map(function (e) {
          ...
          if (e.action == "insert") {
            ...
            for (; o < u; o++) {
              ...
              a.start.row == r &&
                ...
                ((a.start.column == t.column && this.$bias <= 0) || ((a.start.column += l), (a.start.row += f)));
            ...
            for (; o < u; o++) {
              ...
              if (a.start.row < i && (r < a.start.row || (r == a.start.row && t.column < a.start.column)))
          ...
          (this.getCommentFoldRange = function (e, t, n) {
            ...
            if (s && /^comment|string/.test(u)) {
              ...
              (f.start.row = i.getCurrentTokenRow()),
                (f.start.column = i.getCurrentTokenColumn() + (/^comment.start/.test(s.type) ? s.value.length : 2)),
                (i = new o(this, e, t));
              if (n != -1) {
                var l = -1;
                do {
              ...
              return (
                ...
                /^comment.end/.test(s.type) || (f.end.column += s.value.length - 2),
                f
              );
            }
          }),
        ...
        (this.findMatchingBracket = function (e, t) {
          ...
          (this.getMatchingBracketRanges = function (e, t) {
            ...
            var u = new i(e.row, e.column - 1, e.row, e.column),
              a = o[1] ? this.$findClosingBracket(o[1], e) : this.$findOpeningBracket(o[2], e);
            if (!a) return [u];
            ...
            if (t && t.type.indexOf("tag-name") === -1)
              do
                r ? (t = e.stepBackward()) : (t = e.stepForward()),
                  t && (t.value === "/>" ? (r = !0) : t.type.indexOf("tag-name") !== -1 && (n = !0));
              while (t && !n);
            return t;
          }),
                ...
                if (t.type.indexOf("tag-name") !== -1) {
                  ...
                  if (o < 0)
                    var c = new i(
                      ...
                      h = c,
                      p = h,
                      l = new i(a.end.row, a.end.column, a.end.row, a.end.column + 1);
                }
              }
            } while (t && o >= 0);
            if (u && l && c && p && a && h)
                ...
                o.loadModule(
                  ...
                  function (e) {
                    ...
                    this.$modes[r] && !n
                      ...
                      : e &&
                        e.Mode &&
                        ((e = new e.Mode(n)), n || ((this.$modes[r] = e), (e.$id = r)), this.$onChangeMode(e)),
                      t && t();
                  }.bind(this)
                ),
            ...
            (this.$getUndoSelection = function (e, t) {
              ...
              for (var s = 0; s < e.length; s++) {
                ...
                n(o)
                  ...
                  : ((i = o.start), r.compare(i.row, i.column) == -1 && (r = l.fromPoints(o.start, o.start)));
              }
              return r;
            }),
            (this.replace = function (e, t) {
                ...
                (f = this.getFoldLine(l, f)),
                  f
                    ? ((a = []),
                      ...
                      (l = f.end.row + 1))
                    : ((a = this.$getDisplayTokens(r[l])), (o[l] = this.$computeWrapSplits(a, u, i)), l++);
            });
          var e = 1,
            t = 2,
            n = 3,
          ...
          (this.$computeWrapSplits = function (e, r, i) {
            ...
            (this.$getStringScreenWidth = function (e, t, n) {
              ...
              for (i = 0; i < e.length; i++) {
                (r = e.charCodeAt(i)),
                  r == 9 ? (n += this.getScreenTabSize(n)) : r >= 4352 && v(r) ? (n += 2) : (n += 1);
                if (n > t) break;
              }
              return [n, i];
            }),
            ...
            (this.getRowLength = function (e) {
              var t = 1;
              return (
                this.lineWidgets && (t += (this.lineWidgets[e] && this.lineWidgets[e].rowCount) || 0),
            ...
            (this.screenToDocumentPosition = function (e, t, n) {
              ...
              while (u <= e) {
                ...
                (u += a),
                  i++,
                  i > v && ((i = d.end.row + 1), (d = this.getNextFoldLine(i, d)), (v = d ? d.start.row : Infinity)),
              ...
              if (this.$useWrapMode) {
                ...
                y &&
                  ((o = y[g]),
                  g > 0 && y.length && ((m = y.indent), (s = y[g - 1] || y[y.length - 1]), (r = r.substring(s))));
              }
              return (
                n !== undefined && this.$bidiHandler.isBidiRow(u + g, i, g) && (t = this.$bidiHandler.offsetToCol(n)),
            ...
            (this.getScreenLength = function () {
              ...
              if (!this.$useWrapMode) {
                ...
                while (s < i) {
                  ...
                  (e += u ? u.length + 1 : 1),
                    s++,
                    s > o && ((s = t.end.row + 1), (t = this.$foldData[r++]), (o = t ? t.start.row : Infinity));
                }
              }
            ...
            (this.destroy = function () {
              this.destroyed || (this.bgTokenizer.setDocument(null), this.bgTokenizer.cleanup(), (this.destroyed = !0)),
                this.$stopWorker(),
                this.removeAllListeners(),
                this.doc && this.doc.off("change", this.$onChange),
          ...
          wrapMethod: {
            set: function (e) {
              (e = e == "auto" ? this.$mode.type != "text" : e != "text"),
                e != this.$wrapAsCode &&
                  ((this.$wrapAsCode = e), this.$useWrapMode && ((this.$useWrapMode = !1), this.setUseWrapMode(!0)));
            },
            initialValue: "auto",
          },
          indentedSoftWrap: {
          ...
          (this.find = function (e) {
            ...
            return (
              n.forEach(function (e, n, i, o) {
                return (
                  (r = new s(e, n, i, o)),
                  n == o && t.start && t.start.start && t.skipCurrent != 0 && r.isEqual(t.start) ? ((r = null), !1) : !0
                );
              }),
              r
            );
          ...
          (this.findAll = function (e) {
            ...
            if (n) {
              var w = n.start.column,
                ...
                g = 0,
                h = o.length - 1;
              while (g < h && o[g].start.column < w && o[g].start.row == 0) g++;
          ...
          (this.addCommand = function (e) {
            ...
            (this._addCommandToBinding = function (t, n, r) {
              ...
              if (!n) delete i[t];
                ...
                Array.isArray(i[t]) ? (s = i[t].indexOf(n)) != -1 && i[t].splice(s, 1) : (i[t] = [i[t]]),
        ...
        function () {
          r.implement(this, s),
            (this.exec = function (e, t, n) {
              ...
              return (
                (i.returnValue = this._emit("exec", i)), this._signal("afterExec", i), i.returnValue === !1 ? !1 : !0
              );
            }),
          ...
          exec: function (e) {
            ...
            i.row + 1 < e.session.doc.getLength() - 1 && (f += e.session.doc.getNewLineCharacter()),
              ...
              a > 0
                ...
                : ((o = e.session.doc.getLine(n.row).length > o ? o + 1 : o), e.selection.moveCursorTo(n.row, o));
          },
          multiSelectAction: "forEach",
          readOnly: !0,
        },
            ...
            for (var o = 0; o < r.length; o++)
              o == r.length - 1 &&
                ...
                o === 0
                  ...
                  : i.push(new s(r[o - 1].end.row, r[o - 1].end.column, r[o].start.row, r[o].start.column));
  ...
  define(
    ...
    function (e, t, n) {
      ...
      var r =
        ...
        E = function (e, t, n) {
          ...
          (this.container = r),
            ...
            this.setSession(t || (n && n.session) || new h("")),
            y.resetOptions(this),
            n && this.setOptions(n),
      ...
      (E.$uid = 0),
        function () {
          i.implement(this, v),
            (this.$initOperationListeners = function () {
              this.commands.on("exec", this.startOperation.bind(this), !0),
                ...
                this.on(
                  "change",
                  function () {
                    this.curOp || (this.startOperation(), (this.curOp.selectionBefore = this.$lastSel)),
            ...
            (this.$highlightBrackets = function () {
              ...
              (this.$highlightPending = !0),
                setTimeout(function () {
                  ...
                  var f = "ace_bracket";
                  Array.isArray(s) ? s.length == 1 && (f = "ace_error_bracket") : (s = [s]),
                    s.length == 2 &&
                      (d.comparePoints(s[0].end, s[1].start) == 0
                        ? (s = [d.fromPoints(s[0].start, s[1].end)])
                        : d.comparePoints(s[0].start, s[1].end) == 0 && (s = [d.fromPoints(s[1].start, s[0].end)])),
                    (t.$bracketHighlight = {
                      ranges: s,
            ...
            (this.getCopyText = function () {
              ...
              var o = { text: e };
              return this._signal("copy", o), (w.lineMode = n ? o.text : !1), o.text;
            }),
              ...
              n.insert(i, e),
                s &&
                  ...
                  (s.selection.length == 2
                    ? this.selection.setSelectionRange(new d(i.row, f + s.selection[0], i.row, f + s.selection[1]))
                    : this.selection.setSelectionRange(
                        new d(i.row + s.selection[0], s.selection[1], i.row + s.selection[2], s.selection[3])
                      ));
            ...
            (this.autoIndent = function () {
              ...
              var s = "",
                ...
                c = e.getTabString();
              for (var h = n; h <= r; h++)
                h > 0 && ((s = e.getState(h - 1)), (o = e.getLine(h - 1)), (u = t.getNextLineIndent(s, o, c))),
                  (a = e.getLine(h)),
                  (f = t.$getIndent(a)),
                  u !== f &&
                    (f.length > 0 && ((l = new d(h, 0, h, f.length)), e.remove(l)),
            ...
            (this.applyComposition = function (e, t) {
              if (t.extendLeft || t.extendRight) {
                ...
                (n.start.column -= t.extendLeft),
                  ...
                  n.start.column < 0 &&
                    (n.start.row--, (n.start.column += this.session.getLine(n.start.row).length + 1)),
            ...
            (this.transposeLetters = function () {
              ...
              var n = this.session.getLine(e.row),
                ...
                i;
              t < n.length
                ? ((r = n.charAt(t) + n.charAt(t - 1)), (i = new d(e.row, t - 1, e.row, t + 1)))
                : ((r = n.charAt(t - 1) + n.charAt(t - 2)), (i = new d(e.row, t - 2, e.row, t))),
            ...
            (this.toggleWord = function () {
              ...
              n.match(/[A-Za-z0-9_]+/) &&
                i.forEach(function (t, i) {
                  (a = u + t.length),
                    s >= u &&
                      s <= a &&
                      ((n = t), f.selection.clearSelection(), f.moveCursorTo(e, u + r), f.selection.selectTo(e, a + r)),
                    (u = a);
                });
              ...
              for (var h = 0; h < l.length; h++) {
                ...
                for (var d = 0; d <= 1; d++) {
                  var v = +!d,
                    m = n.match(new RegExp("^\\s?_?(" + o.escapeRegExp(p[d]) + ")\\s?$", "i"));
                  if (m) {
                    var g = n.match(new RegExp("([_]|^|\\s)(" + o.escapeRegExp(m[1]) + ")($|\\s)", "g"));
                    g &&
                      ((c = n.replace(new RegExp(o.escapeRegExp(p[d]), "i"), function (e) {
                        var t = p[v];
                        return (
                          e.toUpperCase() == e
                            ? (t = t.toUpperCase())
              ...
              do {
                if (o.value.match(/[{}()\[\]]/g))
                  ...
                  o.type.indexOf("tag-name") !== -1 &&
                    ...
                    i.value === "<" && s > 1 ? f[o.value]++ : i.value === "</" && f[o.value]--,
                ...
                if (p.compare(n.row, n.column) === 0) {
                  ...
                  m &&
                    (m.openTag.contains(n.row, n.column)
                      ...
                      : ((p = m.openTag),
                        m.closeTag.start.row === n.row && m.closeTag.start.column === n.column
                          ? (v = p.end)
                          : (v = p.start)));
                }
                v = v || p.start;
            ...
            (this.find = function (e, t, n) {
              t || (t = {}),
                typeof e == "string" || e instanceof RegExp ? (t.needle = e) : typeof e == "object" && i.mixin(t, e);
              var r = this.selection.getRange();
              t.needle == null &&
                ((e = this.session.getTextRange(r) || this.$search.$options.needle),
                e || ((r = this.session.getWordRange(r.start.row, r.start.column)), (e = this.session.getTextRange(r))),
        ...
        y.defineOptions(E.prototype, "editor", {
          selectionStyle: {
            set: function (e) {
          ...
          showLineNumbers: {
            set: function (e) {
              this.renderer.$gutterLayer.setShowLineNumbers(e),
                ...
                e && this.$relativeLineNumbers ? S.attach(this) : S.detach(this);
            },
            initialValue: !0,
          },
          relativeLineNumbers: {
  ...
  define("ace/undomanager", ["require", "exports", "module", "ace/range"], function (e, t, n) {
    ...
    var r = function () {
      (this.$maxRev = 0), (this.$fromUndo = !1), (this.$undoDepth = Infinity), this.reset();
    };
    (function () {
    ...
    (function () {
      (this.moveContainer = function (e) {
        r.translate(
          this.element,
          0,
          -((e.firstRowScreen * e.lineHeight) % this.canvasHeight) - e.offset * this.$offsetCoefficient
        );
      }),
        ...
        i.implement(this, o),
          ...
          (this.update = function (e) {
            ...
            for (;;) {
              ...
              (o = this.$lines.get(++u)),
                o ? (o.row = a) : ((o = this.$lines.createCell(a, e, this.session, f)), this.$lines.push(o)),
          ...
          (this.$renderLines = function (e, t, n) {
            ...
            for (;;) {
              i > o &&
                ((i = s.end.row + 1), (s = this.session.getNextFoldLine(i, s)), (o = s ? s.start.row : Infinity));
              if (i > n) break;
          ...
          (this.$renderCell = function (e, t, n, i) {
            ...
            this.$highlightGutterLine &&
              (i == this.$cursorRow || (n && i < this.$cursorRow && i >= d && this.$cursorRow <= n.end.row)) &&
    ...
    (function () {
      ...
      (this.$padding = 0),
        ...
        (this.elt = function (e, t) {
          ...
          n ? this.i++ : ((n = document.createElement("div")), this.element.appendChild(n), (this.i = -1)),
            (n.style.cssText = t),
            (n.className = e);
        }),
        (this.update = function (e) {
        ...
        (this.drawMultiLineMarker = function (e, t, n, r, i) {
          ...
          if (this.session.$bidiHandler.isBidiRow(t.end.row)) {
            ...
            this.elt(
              n + " ace_br12",
              "height:" + o + "px;" + "width:" + l + "px;" + "top:" + u + "px;" + "left:" + s + "px;" + (i || "")
            );
          }
          ...
          this.elt(
            n + (c ? " ace_br" + c : ""),
            "height:" + o + "px;" + "right:0;" + "top:" + u + "px;" + "left:" + s + "px;" + (i || "")
          );
        }),
        (this.drawSingleLineMarker = function (e, t, n, r, i, s) {
          ...
          this.elt(
            n,
            "height:" + o + "px;" + "width:" + u + "px;" + "top:" + a + "px;" + "left:" + f + "px;" + (s || "")
          );
        }),
      ...
      (function () {
        r.implement(this, u),
          ...
          (this.updateLines = function (e, t, n) {
            ...
            for (;;) {
              u > l &&
                ((u = a.end.row + 1), (a = this.session.getNextFoldLine(u, a)), (l = a ? a.start.row : Infinity));
              if (u > i) break;
              var c = s[o++];
              if (c) {
          ...
          (this.scrollLines = function (e) {
            ...
            if (t.lastRow > e.lastRow)
              for (var i = this.session.getFoldedRowCount(e.lastRow + 1, t.lastRow); i > 0; i--) this.$lines.pop();
          ...
          (this.$renderLinesFragment = function (e, t, n) {
            ...
            for (;;) {
              s > u &&
                ((s = o.end.row + 1), (o = this.session.getNextFoldLine(s, o)), (u = o ? o.start.row : Infinity));
              if (s > n) break;
              var a = this.$lines.createCell(s, e, this.session),
                f = a.element;
              this.dom.removeChildren(f),
                i.setStyle(f.style, "height", this.$lines.computeLineHeight(s, e, this.session) + "px"),
                ...
                this.$useLineGroups()
                  ...
                  : ((f.className = "ace_line"), f.setAttribute("role", "option")),
                r.push(a),
                s++;
            }
            return r;
          ...
          (this.$renderTokenInChunks = function (e, t, n, r) {
            var i;
            for (var s = 0; s < r.length; s += this.MAX_CHUNK_LENGTH) {
              var o = r.substring(s, s + this.MAX_CHUNK_LENGTH),
                u = { type: n.type, value: o };
              i = this.$renderToken(e, t + s, u, o);
            }
            return i;
          }),
          (this.$renderToken = function (e, t, n, r) {
            ...
            while ((a = o.exec(r))) {
              ...
              if (l) {
                ...
                (g.style.width = i.config.characterWidth * 2 + "px"),
                  (g.className = i.showSpaces ? "ace_cjk ace_invisible ace_invisible_space" : "ace_cjk"),
            ...
            if (!this.$textToken[n.type]) {
              ...
              n.type == "fold" && (g.style.width = n.value.length * this.config.characterWidth + "px"),
                (g.className = y);
            }
            return g.appendChild(u), e.appendChild(g), t + r.length;
          }),
          ...
          (this.$highlightIndentGuide = function () {
            ...
            this.$highlightIndentGuideMarker = { indentLevel: r, start: t.row };
          ...
          (this.$renderWrappedLine = function (e, t, n) {
            ...
            for (var f = 0; f < t.length; f++) {
              ...
              if (r + c.length < o) (u = this.$renderTokenInChunks(a, u, l, c)), (r += c.length);
              else {
                while (r + c.length >= o)
                  (u = this.$renderTokenInChunks(a, u, l, c.substring(0, o - r))),
                    (c = c.substring(o - r)),
                    (r = o),
                    (a = this.$createLineElement()),
                    e.appendChild(a),
                    a.appendChild(this.dom.createTextNode(s.stringRepeat("\u00a0", n.indent), this.element)),
                    i++,
                    (u = 0),
                    (o = n[i] || Number.MAX_VALUE);
                c.length != 0 && ((r += c.length), (u = this.$renderTokenInChunks(a, u, l, c)));
              }
            }
          ...
          (this.$renderSimpleLine = function (e, t) {
            ...
            for (var r = 0; r < t.length; r++) {
              ...
              if (n + s.length > this.MAX_LINE_LENGTH) {
                this.$renderOverflowMessage(e, n, i, s);
                return;
              }
              n = this.$renderTokenInChunks(e, n, i, s);
            }
          }),
          ...
          (this.$getFoldLineTokens = function (e, t) {
            function i(e, t, n) {
              ...
              while (s < n && i < e.length) {
                var o = e[i].value;
                o.length + s > n ? r.push({ type: e[i].type, value: o.substring(0, n - s) }) : r.push(e[i]),
                  (s += o.length),
                  (i += 1);
              }
            }
      ...
      (this.$updateOpacity = function (e) {
        ...
        (this.restartTimer = function () {
          ...
          clearInterval(this.intervalId),
            ...
            this.smoothBlinking &&
              ((this.$isSmoothBlinking = !1), r.removeCssClass(this.element, "ace_smooth-blinking")),
            e(!0);
      ...
      r.inherits(f, a),
        function () {
          (this.classSuffix = "-v"),
            ...
            (this.setScrollTop = function (e) {
              this.scrollTop != e &&
                ((this.skipEvent = !0), (this.scrollTop = e), (this.element.scrollTop = e * this.coeff));
            });
        }.call(f.prototype);
      var l = function (e, t) {
        a.call(this, e),
      ...
      r.inherits(l, a),
        function () {
          (this.classSuffix = "-h"),
            (this.onScroll = function () {
              this.skipEvent ||
                ((this.scrollLeft = this.element.scrollLeft), this._emit("scroll", { data: this.scrollLeft })),
                (this.skipEvent = !1);
            }),
            (this.getHeight = function () {
    ...
    function (e, t, n) {
      ...
      var u = function (e) {
        (this.element = i.createElement("div")),
          ...
          this.setVisible(!1),
          (this.skipEvent = !1),
          s.addMultiMouseDownListener(this.element, [500, 300, 300], this, "onMouseDown");
      };
      (function () {
        r.implement(this, o),
          (this.setVisible = function (e) {
        ...
        function () {
          (this.classSuffix = "-v"),
            ...
            (this.onMouseDown = function (e, t) {
              ...
              if (s.getButton(t) !== 0 || t.detail === 2) return;
              if (t.target === this.inner) {
                ...
                s.capture(this.inner, i, o);
                var l = setInterval(f, 20);
                return s.preventDefault(t);
              }
              var c = t.clientY - this.element.getBoundingClientRect().top - this.thumbHeight / 2;
              return this._emit("scroll", { data: this.scrollTopFromThumbTop(c) }), s.preventDefault(t);
            }),
            (this.getHeight = function () {
              return this.height;
            }),
        ...
        function () {
          (this.classSuffix = "-h"),
            ...
            (this.onMouseDown = function (e, t) {
              ...
              return this._emit("scroll", { data: this.scrollLeftFromThumbLeft(c) }), s.preventDefault(t);
            }),
            (this.getHeight = function () {
              return this.isVisible ? this.height : 0;
            }),
            ...
            (this.setInnerWidth = this.setScrollWidth =
              function (e, t) {
      ...
      var r = e("../lib/oop"),
        ...
        h = (t.FontMetrics = function (e, t) {
          (this.charCount = t || f),
            ...
            (this.$measureNode.textContent = s.stringRepeat("X", this.charCount)),
        ...
        r.implement(this, a),
          ...
          (this.$measureSizes = function (e) {
            ...
            var t = e.getBoundingClientRect(),
              n = { height: t.height, width: t.width / this.charCount };
            return n.width === 0 || n.height === 0 ? null : n;
          }),
          (this.$measureCharWidth = function (e) {
            this.$main.textContent = s.stringRepeat(e, this.charCount);
          ...
          (this.getCharacterWidth = function (e) {
            ...
            return (
              t === undefined && (t = this.charSizes[e] = this.$measureCharWidth(e) / this.$characterSize.width), t
            );
          }),
          (this.destroy = function () {
  ...
  define("ace/css/editor.css", ["require", "exports", "module"], function (e, t, n) {
    n.exports =
  ...
  define(
    ...
    ["require", "exports", "module", "ace/lib/dom", "ace/lib/oop", "ace/lib/event_emitter"],
    function (e, t, n) {
      "use strict";
      var r = e("../lib/dom"),
        i = e("../lib/oop"),
        ...
        o = function (e, t) {
          (this.canvas = r.createElement("canvas")),
            ...
            (this.colors.light = { error: "rgb(255,51,51)", warning: "rgb(32,133,72)", info: "rgb(35,68,138)" }),
            ...
            if (s) {
              ...
              for (var a = 0; a < s.length; a++) {
                var f = s[a].row,
                  ...
                  c = Math.round((f - l) * this.lineHeight * this.heightRatio),
                  h = Math.round((f - l) * this.lineHeight * this.heightRatio),
                  p = Math.round(((f - l) * this.lineHeight + this.lineHeight) * this.heightRatio),
                  d = p - h;
                ...
                (r.fillStyle = t[s[a].type] || null), r.fillRect(0, c, this.canvasWidth, p - h);
              }
            }
            var m = this.renderer.session.selection.getCursor();
            if (m) {
              var l = this.compensateFoldRows(m.row, u),
                c = Math.round((m.row - l) * this.lineHeight * this.heightRatio);
              (r.fillStyle = "rgba(0, 0, 0, 0.5)"), r.fillRect(0, c, this.canvasWidth, 2);
            }
          }),
    ...
    function (e, t, n) {
      ...
      var E = function (e, t) {
        ...
        (this.canvas = r.element),
          ...
          (this.$fontMetrics = new v(this.container, this.$textLayer.MAX_CHUNK_LENGTH)),
      ...
      (function () {
        (this.CHANGE_CURSOR = 1),
          ...
          (this.$moveTextAreaToCursor = function () {
            ...
            var r = this.layerConfig,
              ...
              o = n.left;
            s -= r.offset;
            var u = t && t.useTextareaForIME ? this.lineHeight : w ? 0 : 1;
            if (s < 0 || s > r.height - u) {
          ...
          (this.$renderChanges = function (e, t) {
            ...
            e & this.CHANGE_TEXT
              ...
              : e & this.CHANGE_CURSOR &&
                (this.$highlightGutterLine && this.$gutterLayer.updateLineHighlight(n),
                this.$customScrollbar && this.$scrollDecorator.$updateDecorators(n)),
          ...
          (this.$computeLayerConfig = function () {
            ...
            var f = t.scrollerHeight + this.lineHeight,
              l =
                !this.$maxLines && this.$scrollPastEnd ? (t.scrollerHeight - this.lineHeight) * this.$scrollPastEnd : 0;
            i += l;
            var c = this.scrollMargin;
            this.session.setScrollTop(Math.max(-c.top, Math.min(this.scrollTop, i - t.scrollerHeight + c.bottom))),
              this.session.setScrollLeft(
                Math.max(-c.left, Math.min(this.scrollLeft, s + 2 * this.$padding - t.scrollerWidth + c.right))
              );
          ...
          (this.scrollCursorIntoView = function (e, t, n) {
            ...
            a + o > s
              ...
              : a + this.$size.scrollerHeight - u < s + this.lineHeight &&
                (t && a + this.$size.scrollerHeight - u < s - this.lineHeight && (s += t * this.$size.scrollerHeight),
            ...
            i - l < f
              ? ((i -= l), i < this.$padding + l && (i = -this.scrollMargin.left), this.session.setScrollLeft(i))
              : ((i += l),
          ...
          (this.$updateCustomScrollbar = function (e) {
            ...
            (this.$horizScroll = this.$vScroll = null),
              ...
              e === !0
                ? ((this.scrollBarV = new p(this.container, this)),
                ...
                : ((this.scrollBarV = new c(this.container, this)),
                  (this.scrollBarH = new l(this.container, this)),
                  this.scrollBarV.addEventListener("scroll", function (e) {
                    t.$scrollAnimation || t.session.setScrollTop(e.data - t.scrollMargin.top);
                  }),
        ...
        s.defineOptions(E.prototype, "renderer", {
          ...
          hasCssTransforms: {},
          useTextareaForIME: { initialValue: !b.isMobile && !b.isIE },
        }),
        (t.VirtualRenderer = E);
    }
  ),
  define(
    ...
    function (e, t, n) {
      ...
      function a(e) {
        if (typeof Worker == "undefined") return { postMessage: function () {}, terminate: function () {} };
        ...
        r.implement(this, s),
          ...
          (this.emit = function (e, t) {
            try {
              t.data &&
                t.data.err &&
                (t.data.err = { message: t.data.err.message, stack: t.data.err.stack, code: t.data.err.code }),
          ...
          (this.changeListener = function (e) {
            this.deltaQueue || ((this.deltaQueue = []), setTimeout(this.$sendDeltaQueue, 0)),
              e.action == "insert" ? this.deltaQueue.push(e.start, e.lines) : this.deltaQueue.push(e.start, e.end);
          }),
          ...
          (l.inVirtualSelectionMode = !0),
            ...
            l.once("mouseup", function () {
              ...
              T && e.isEmpty() && s(T.cursor, e.cursor)
                ...
                : (o ? c.substractPoint(x.cursor) : x && (l.removeSelectionMarker(x), c.addRange(x)), c.addRange(e)),
    ...
    (function () {
      (this.getRowLength = function (e) {
        ...
        (this.updateOnFold = function (e, t) {
          ...
          n[s] &&
            (o ? (n[i] ? (n[s].hidden = o) : (n[i] = n[s])) : (n[i] == n[s] && (n[i] = undefined), (n[s].hidden = o)));
        }),
        (this.updateOnChange = function (e) {
        ...
        (this.measureWidgets = function (e, t) {
          ...
          i != Infinity &&
            (this.session._emit("changeFold", { data: { start: { row: i } } }), (this.session.lineWidgetWidth = null)),
            (this.session._changedWidgets = []);
        }),
        (this.renderWidgets = function (e, t) {
          ...
          for (var o = i; o <= s; o++) {
            ...
            u.fixedWidth || (f -= t.scrollLeft),
              ...
              u.fixedWidth ? (u.el.style.right = t.scrollBar.getWidth() + "px") : (u.el.style.right = "");
          }
        });
    }).call(i.prototype),
      (t.LineWidgets = i);
